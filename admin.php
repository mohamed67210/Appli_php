        ...
        <div class="w-full max-w-xs flex  flex-col justify-center items-center">
            ...
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="traitement.php?action=ajouterProduit" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input name="description" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="description" type="text" required>
                </div>
                <div class="mb-4">
